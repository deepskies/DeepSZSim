...
For further examples, see the notebooks [[1](docs/source/notebooks/demo_full_pipeline.ipynb)] [[2](docs/source/notebooks/demo_simulation.ipynb)]. To run these locally, you will need to install as described in the [Installation](#installation) section, and then do
```commandline
